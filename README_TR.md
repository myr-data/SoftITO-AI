...
- Yazılım Analizi ve Tasarımı
- DevOps
- Programlama Metodolojisi ve Kaynak Kod Yönetimi
- Veri Yapıları ve Temel Algoritmalar
- İşletim Sistemlerinin Temelleri
- Ağ ve Sistemlerin Temelleri
- Yazılım Mimarileri
- Güvenli Yazılım Geliştirmenin Temelleri
- Veritabanı Kullanımı ve Yönetimi
- Siber Güvenlik Farkındalığı
- Uluslararası BT Standartları
- İş Etiği ve Çalışma Kültürü
- Python Programlama Dili
- İstatistik ve Doğrusal Cebir Temelleri
...
- Spark ve Hadoop Uygulamalı Eğitimi
- Airflow ile ETL/ELT Süreçleri ve İş Akışı Yönetimi
- Vektör Veritabanları ve Anlamsal Arama
- Veri Yönetişimi
- İleri Düzey RAG Mimarileri
- Otonom Yapay Zeka Aracısı Geliştirme
- İnce Ayar Çalıştayı
- Model Değerlendirme Metrikleri ve RAGAS
- Bilgisayarlı Görme
- Gerçek Zamanlı Video Analitiği ve Akış İşleme
- Üretken Görme
- Docker ve Kubernetes (K8s) Temelleri
- API Geliştirme: FastAPI ile Yüksek Performanslı Çıkarım Hizmetleri
- Model Dağıtımı
- Canlı Model İzleme
- Sektöre Özgü Senaryoların Tanımlanması ve Veri Hazırlama
- Uçtan Uca Proje Geliştirme
- Proje Sunumu ve Teknik Raporlama
